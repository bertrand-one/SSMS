    ...
    <body class="bg-amber-100 grid grid-cols-2 items-center">
       <div class="flex flex-col justify-center items-center">
          ...
          <form action="register.post" method="POST">
            ...
            <button type="submit" class="btn bg-green-700 text-amber-100 mt-5 w-full">Create</button>
          </form>
       ...
       <div class="h-[100vh] bg-green-700 flex flex-col items-center justify-center px-12 text-amber-100">
            ...
            <p class="py-12">if you have an account already</p>
            <a href="/login"><button class="btn bg-amber-100 text-black rounded-full">Login</button></a>
       </div>
    </body>
</html>
